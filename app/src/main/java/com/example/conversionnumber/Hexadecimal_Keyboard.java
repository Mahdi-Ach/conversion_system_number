...
public class Hexadecimal_Keyboard extends LinearLayout implements View.OnClickListener {

    // constructors
    public Hexadecimal_Keyboard(Context context) {
        this(context, null, 0);
    }

    public Hexadecimal_Keyboard(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Hexadecimal_Keyboard(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // initialize buttons
        LayoutInflater.from(context).inflate(R.layout.hexadecimal_keyboard, this, true);
